...
const App = () => (
  <div className="min-h-screen bg-slate-900 text-white flex flex-col md:flex-row items-center justify-between p-6">
    {/* Left Side: Banner and Messaging */}
    ...
    <div className="w-full md:w-1/2 bg-slate-800 p-6 rounded shadow-lg">
      ...
      <p className="mb-4">JET Program participants must sign in below using their issued JET ID.</p>
      ...
      <form className="space-y-4">
        ...
        <p className="text-sm mt-2">Need to create your account? <a href="#" className="text-blue-400 underline">Sign Up</a></p>
      </form>
    </div>
  </div>
);
